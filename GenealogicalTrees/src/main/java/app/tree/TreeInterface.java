...
public interface TreeInterface {
	 ...
	 * 
	 * x$y functions are analogs of bind (>>=) operator from Haskell. x_y functions
	 * are analogs of forgetful bind (>>) from Haskell.
	 * 
	 * Inside Tree we have 2 lists, hence we have 4 implementations of each bind.
	 * Perhaps it would be better to call it Diadic navigation.
	 * 
	...
	/*
	 * Tree types (not TreeInterfaces) because of we take methods from other classes
	 * that work with real, not abstract data. It violates abstract design but
	 * should work.
	 */
